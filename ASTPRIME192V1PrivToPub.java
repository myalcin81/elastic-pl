...
/* Generated By:JJTree: Do not edit this line. ASTPRIME192V1PrivToPub.java Version 4.3 */
/* JavaCCOptions:MULTI=true,NODE_USES_PARSER=false,VISITOR=false,TRACK_TOKENS=true,NODE_PREFIX=AST,NODE_EXTENDS=MyNode,NODE_FACTORY=,SUPPORT_CLASS_VISIBILITY_PUBLIC=true */
public
class ASTPRIME192V1PrivToPub extends AbstractPrivToPub {
  public ASTPRIME192V1PrivToPub(int id) {
    super(id);
  }

  public ASTPRIME192V1PrivToPub(ElasticPLParser p, int id) {
    super(p, id);
  }
