...
public class ASTRIPEMD128 extends SimpleNode {


	public ASTRIPEMD128(int id) {

		super(id);
	}

	public ASTRIPEMD128(ElasticPLParser p, int id) {
		super(p, id);
	}
	...
	public void interpret() {
		...
		// do hash
		byte[] result = this.computeRIPEMD128(this.StateIntToBytes(position_to_start, byte_length));
