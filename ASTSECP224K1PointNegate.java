...
/* Generated By:JJTree: Do not edit this line. ASTSECP224K1PointNegate.java Version 4.3 */
/* JavaCCOptions:MULTI=true,NODE_USES_PARSER=false,VISITOR=false,TRACK_TOKENS=true,NODE_PREFIX=AST,NODE_EXTENDS=MyNode,NODE_FACTORY=,SUPPORT_CLASS_VISIBILITY_PUBLIC=true */
public
class ASTSECP224K1PointNegate extends AbstractPointNegate {
  public ASTSECP224K1PointNegate(int id) {
    super(id);
  }

  public ASTSECP224K1PointNegate(ElasticPLParser p, int id) {
    super(p, id);
  }
