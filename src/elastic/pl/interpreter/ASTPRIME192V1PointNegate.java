...
/* Generated By:JJTree: Do not edit this line. ASTPRIME192V1PointNegate.java Version 4.3 */
/* JavaCCOptions:MULTI=true,NODE_USES_PARSER=false,VISITOR=false,TRACK_TOKENS=true,NODE_PREFIX=AST,NODE_EXTENDS=MyNode,NODE_FACTORY=,SUPPORT_CLASS_VISIBILITY_PUBLIC=true */
public
class ASTPRIME192V1PointNegate extends AbstractPointNegate {
  public ASTPRIME192V1PointNegate(int id) {
    super(id);
  }

  public ASTPRIME192V1PointNegate(ElasticPLParser p, int id) {
    super(p, id);
  }
