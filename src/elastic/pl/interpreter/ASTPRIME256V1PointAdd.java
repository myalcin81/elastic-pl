...
/* Generated By:JJTree: Do not edit this line. ASTPRIME256V1PointAdd.java Version 4.3 */
/* JavaCCOptions:MULTI=true,NODE_USES_PARSER=false,VISITOR=false,TRACK_TOKENS=true,NODE_PREFIX=AST,NODE_EXTENDS=MyNode,NODE_FACTORY=,SUPPORT_CLASS_VISIBILITY_PUBLIC=true */
public
class ASTPRIME256V1PointAdd extends AbstractPointAdd {
  public ASTPRIME256V1PointAdd(int id) {
    super(id);
  }

  public ASTPRIME256V1PointAdd(ElasticPLParser p, int id) {
    super(p, id);
  }
