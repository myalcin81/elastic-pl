...
public class ASTTiger extends SimpleNode {


	public ASTTiger(int id) {

		super(id);
	}

	public ASTTiger(ElasticPLParser p, int id) {
		super(p, id);
	}

	

	public byte[] computeTIGER(byte[] message) {
	...
	public void interpret() {
		...
		// do hash
		byte[] result = this.computeTIGER(this.StateIntToBytes(position_to_start, byte_length));
